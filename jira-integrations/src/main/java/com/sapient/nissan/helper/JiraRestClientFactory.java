package com.sapient.nissan.helper;
...
import com.sapient.nissan.config.JiraProcessorConfig;
import com.sapient.nissan.impl.ProcessorJiraRestClient;
import com.sapient.nissan.oauth.JiraOAuthClient;
import com.sapient.nissan.util.RestOperationFactory;
...
//import com.sapient.nissan.models.JiraInfo;
//import com.sapient.nissan.util.RestOperationFactory;

@Component
public class JiraRestClientFactory implements RestOperationFactory<JiraRestClient> {
...
//	}
	...
	@Override
	public JiraRestClient getTypeInstance() {
